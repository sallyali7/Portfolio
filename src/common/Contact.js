    ...
    <section className="container contact mt-5" id="contact">
      ...
      <div className="contact-media row mt-5">
        <div className="contact-icon col-4 justify-content-center">
          <a href="https://github.com/sallyali7" className="text-decoration-none contact-details" target="_blank" rel="noreferrer">
            ...
            <p className="link">github.com/sallyali7</p>
          </a>
        </div>
        <div className="contact-icon col-4 justify-content-center">
          <a href="https://www.linkedin.com/in/sallysghair" className="text-decoration-none contact-details" target="_blank" rel="noreferrer">
            ...
            <p className="link">linkedin.com/in/sallysghair</p>
          </a>
        </div>
        <div className="contact-icon col-4 justify-content-center">
          <a href="mailto:sallysghair1@gmail.com" className="text-decoration-none contact-details" target="_blank" rel="noreferrer">
            ...
            <p className="link">sallysghair1@gmail.com</p>
          </a>
        </div>
      </div>
    </section>
