...
function NavBar() {
  return ( 
    <nav className="navbar navbar-expand-lg navbar-dark rounded" aria-label="Twelfth navbar example">
      <div className="container-fluid">
        ...
        <div className="collapse navbar-collapse navbar-dark justify-content-md-center" id="navbarsExample10">
